-- Security Enhancements for Subscription System
-- Migration: 20250105_008_add_security_enhancements.sql
...
CREATE TABLE IF NOT EXISTS subscription_audit_log (
  ...
  target_subscription_id UUID REFERENCES user_subscriptions(id),
