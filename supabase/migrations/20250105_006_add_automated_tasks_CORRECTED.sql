-- Automated Subscription Management Tasks (CORRECTED)
-- Migration: 20250105_006_add_automated_tasks_CORRECTED.sql
...
CREATE TABLE IF NOT EXISTS scheduled_tasks (
  ...
  -- REMOVED: updated_at column (not available in user's schema)
  created_by UUID -- CORRECTED: Made nullable to avoid auth reference failures
);
...
CREATE TABLE IF NOT EXISTS task_execution_logs (
  ...
  triggered_by_user UUID -- CORRECTED: Made nullable to avoid auth reference failures
);
