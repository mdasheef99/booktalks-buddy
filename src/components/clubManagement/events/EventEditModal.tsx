 ...
 *
 * Modal for editing existing club meetings.
 */

import React, { useState, useEffect } from 'react';
import { Edit, Calendar, Clock, Users, Video, Type, FileText } from 'lucide-react';
...
interface EventEditModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onEventUpdated: (updates: UpdateMeetingRequest) => Promise<void>;
  clubId: string;
}
  ...
  useEffect(() => {
    if (event) {
      setFormData({
        ...
        scheduled_at: format(new Date(event.scheduled_at), "yyyy-MM-dd'T'HH:mm"),
