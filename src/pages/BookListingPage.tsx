...
import { BookListingForm } from '@/components/landing/BookListingForm';
import { useStoreId } from '@/hooks/useStoreId';
import { useSectionAnimation } from '@/hooks/useScrollAnimation';
import { cn } from '@/lib/utils';

/**
 * Book Listing Page Component
 * Standalone page for book listing submissions with informational content and form
 */
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-bookconnect-sage/10 to-bookconnect-cream/20">
        <div className="text-center">
          ...
          <h2 className="text-xl font-serif text-bookconnect-brown mb-2">Loading Book Listing</h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={headerRef} className={cn("text-center mb-12", headerAnimation)}>
            ...
            <p className="text-lg text-bookconnect-brown/80 max-w-2xl mx-auto leading-relaxed">
              Fill out the form below to list a book you'd like to sell. We'll review it and contact you directly with an offer.
            </p>
          </div>
          ...
          {/* Form Section */}
          <div ref={contentRef} className={cn("max-w-4xl mx-auto", contentAnimation)}>
            <BookListingForm
              storeId={storeId}
